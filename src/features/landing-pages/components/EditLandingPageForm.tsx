...
import { updateLandingPageServer } from "../actions/server/updateLandingPageServer";
...
export default function EditLandingPageForm({
  ...
  const form = useForm({
    defaultValues: {
      ...
      landingPageProducts: landingPage.landingPageProducts.map((item) => ({
