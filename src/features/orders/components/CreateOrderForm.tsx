    ...
    >
      ...
      <FieldGroup className="border rounded-md p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <form.Field
            name="customer.address.division"
            children={(field) => {
              const isInvalidCustomerAddressDivision =
                field.state.meta.isTouched && !field.state.meta.isValid;
              return (
                <Field data-invalid={isInvalidCustomerAddressDivision}>
                  ...
                  <Input
                    ...
                    onChange={(e) => field.handleChange(e.target.value)}
                    placeholder="Dhaka"
                    aria-invalid={isInvalidCustomerAddressDivision}
                  />
                  {isInvalidCustomerAddressDivision && (
                    <FieldError errors={field.state.meta.errors} />
                  )}
                </Field>
              );
          ...
          <form.Field
            ...
            children={(field) => {
              const isInvalidCustomerAddressDistrict =
                field.state.meta.isTouched && !field.state.meta.isValid;
              return (
                <Field data-invalid={isInvalidCustomerAddressDistrict}>
                  ...
                  <Input
                    ...
                    onChange={(e) => field.handleChange(e.target.value)}
                    placeholder="Dhaka"
                    aria-invalid={isInvalidCustomerAddressDistrict}
                  />
                  {isInvalidCustomerAddressDistrict && (
                    <FieldError errors={field.state.meta.errors} />
                  )}
                </Field>
              );
          ...
          />
          <form.Field
            name="customer.address.upazilla"
            children={(field) => {
              const isInvalidCustomerAddressUpazilla =
                field.state.meta.isTouched && !field.state.meta.isValid;
              return (
                <Field data-invalid={isInvalidCustomerAddressUpazilla}>
                  <FieldLabel htmlFor={field.name}>Upazilla</FieldLabel>
                  <Input
                    id={field.name}
                    name={field.name}
                    value={field.state.value}
                    ...
                    onChange={(e) => field.handleChange(e.target.value)}
                    placeholder="Savar"
                    aria-invalid={isInvalidCustomerAddressUpazilla}
                  />
                  {isInvalidCustomerAddressUpazilla && (
                    <FieldError errors={field.state.meta.errors} />
                  )}
                </Field>
              );
