        ...
        <Card className="gap-4">
          ...
          <CardContent className="space-y-2">
            <div className="flex items-center gap-2">
              ...
              <p>{order.customer.address.location}</p>
            </div>
            <div className="flex items-center gap-2">
              <strong className="font-medium">Upazilla:</strong>
              <p>{order.customer.address.upazilla}</p>
            </div>
            <div className="flex items-center gap-2">
              <strong className="font-medium">District:</strong>
              <p>{order.customer.address.district}</p>
            </div>
            <div className="flex items-center gap-2">
              <strong className="font-medium">Division:</strong>
              <p>{order.customer.address.division}</p>
            </div>
          </CardContent>
        </Card>
      </div>
